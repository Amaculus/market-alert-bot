...
class MarketMonitor:
    ...
    def __init__(self):
        ...
        self.min_volume_tier_s = float(os.getenv('MIN_VOLUME_TIER_S', '25000'))
        self.min_volume_tier_a = float(os.getenv('MIN_VOLUME_TIER_A', '50000'))
        self.min_volume_tier_c = float(os.getenv('MIN_VOLUME_TIER_C', '100000'))
    ...
    def check_markets(self) -> None:
        ...
        try:
            ...
            # Store snapshots and detect hot markets
            hot_markets = []
